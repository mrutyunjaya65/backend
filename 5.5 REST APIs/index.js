...
//to access req.body, the server needs to parse incoming request bodies, which is often done with middleware like express.json() or express.urlencoded() in Express
